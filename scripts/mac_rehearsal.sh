...
"$PY" scripts/check_r6_flat_account_boundary.py
...
"$PY" scripts/check_mac_safety_rehearsal_boundary.py
...
"$PY" scripts/mac_safety_rehearsal.py >/dev/null
"$PY" scripts/mac_safety_rehearsal.py --reconciliation-failed >/dev/null
"$PY" scripts/mac_safety_rehearsal.py --kill-switch >/dev/null
...
Try Capital Safety locally:
  bash scripts/mac_start.sh safety-rehearsal
  bash scripts/mac_start.sh safety-rehearsal --reconciliation-failed
